...
class UpdateFinanceUseCase(private val financeRepository: FinanceRepository) : UseCase<Pair<FinancePutRequest, String>, Unit>() {
    override suspend fun execute(param: Pair<FinancePutRequest, String>): Flow<Unit> {
